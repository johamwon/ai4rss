...
4. 阶段 11 RANK-003：实现来源多样性、探索配额、负反馈和主题屏蔽。
...
- `river_preferences`：22 个测试通过，新增固定候选多因子排序、六因子解释、输入乱序、主题去重、完全同分、1,000 候选属性、时效半衰期和非法输入覆盖；继续验证 1,000 组信号属性、来源/主题画像、重复点击封顶、阅读状态机及模型版本。
...
- Harness：fixtures 23/23、feeds 3/3、extraction 7/7、AI replay 8/8（必要事实 24/24、禁用声明命中 0/16、中英双语、八类内容、四个高风险样例）、AI provider replay 5/5、AI long replay 1/1、AI cache replay 1/1、ranking 6/6。
