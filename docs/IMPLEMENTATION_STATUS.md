...
4. 阶段 12 CLOUD-003：实现云 TTS 分段、缓存、清理和网络策略。
...
- `river_test_harness`：11 组共 67 项检查通过，新增云端全文私网字面量、私网重定向、DNS 重绑定、超大响应和恶意 HTML Replay；继续覆盖托管 AI 故障/超时/重复/降级、本地排序实验、生产排序、Fixture、Feed、正文提取、AI 黄金集与供应商/长文/缓存 Replay。
