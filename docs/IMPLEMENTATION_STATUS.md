...
4. 阶段 12 CLOUD-002：实现云端全文救援解析与完整 SSRF 防护。
...
- `river_test_harness`：10 组共 62 项检查通过，新增托管 AI 的 Provider 故障、超时、并发重复和质量降级 Replay；继续覆盖本地排序实验 `ship`/`hold`/样本不足、生产排序、Fixture、Feed、正文提取、AI 黄金集、供应商/长文/缓存 Replay 和确定性场景。
...
- Harness：fixtures 23/23、feeds 3/3、extraction 7/7、AI replay 8/8（必要事实 24/24、禁用声明命中 0/16、中英双语、八类内容、四个高风险样例）、AI provider replay 5/5、AI long replay 1/1、AI cache replay 1/1、managed AI gateway replay 4/4（7 次有界调用、750 微单位已接受成本、诊断无私人内容）、ranking 7/7、ranking experiment replay 3/3。
