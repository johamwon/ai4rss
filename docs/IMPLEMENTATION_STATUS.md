...
1. READ-006/007：离线下载、网络恢复、失败任务重试及键盘快捷键。
...
- `river_data`：37 个测试通过，新增中文/英文/特殊字符搜索、状态过滤、索引触发器、v1/v2/v3→v4、中断恢复、当前库打开及 10,000 篇文章 P95 1.7ms 基准。
- `river_app`：41 个测试通过，新增全文失败恢复、强制重解析、外部原文入口和安全报告覆盖，并继续覆盖离线订阅、后台刷新、渐进阅读和五组跨尺寸/主题 Golden。
