...
4. 阶段 13 COM-001：完成 Free/Pro 权益快照、签名、离线缓存和统一 Gate。
...
- `river_test_harness`：14 组共 81 项检查通过，新增滚动成本异常、选择性 Kill Switch、伪造快照和本地核心降级 Replay；继续覆盖播客转录、云 TTS、云端全文 SSRF、托管 AI 故障/超时/重复/降级、本地排序实验、生产排序、Fixture、Feed、正文提取、AI 黄金集与供应商/长文/缓存 Replay。
