...
4. 阶段 13 COM-003：接入 App Store、Google Play 与 Windows 支付渠道。
...
- `river_test_harness`：16 组共 92 项检查通过，新增用量重试、失败、重复返还、并发预留和阈值提醒 Replay；继续覆盖商业权益、云治理、播客转录、云 TTS、云端全文 SSRF、托管 AI、本地排序实验、生产排序、Fixture、Feed、正文提取及 AI Replay。
