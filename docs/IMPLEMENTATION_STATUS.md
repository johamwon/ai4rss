...
4. 阶段 12 CLOUD-001：实现模型路由、Provider 密钥代理、限流、超时、熔断和质量回退。
...
- `river_test_harness`：9 组共 58 项检查通过，新增本地排序实验 `ship`/`hold`/样本不足判定和聚合导出隐私 Replay；继续覆盖生产排序、Fixture、Feed、正文提取、AI 黄金集、供应商/长文/缓存 Replay 和确定性时间/HTTP/AI 场景。
...
- Harness：fixtures 23/23、feeds 3/3、extraction 7/7、AI replay 8/8（必要事实 24/24、禁用声明命中 0/16、中英双语、八类内容、四个高风险样例）、AI provider replay 5/5、AI long replay 1/1、AI cache replay 1/1、ranking 7/7、ranking experiment replay 3/3。
