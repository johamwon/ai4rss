...
4. 阶段 11 RANK-002：实现语义、来源、主题、完成概率、时效和探索排序。
...
- `river_preferences`：15 个测试通过，新增 1,000 组信号属性、半衰期、来源/主题模拟会话、重复点击封顶、最新点击选择、身份冲突和模型版本覆盖；继续验证前台、可见分屏、后台、锁屏、页面不可见、挂机超时、跳读、增量 flush、倒退时钟及长会话切分。
...
- Harness：fixtures 23/23、feeds 3/3、extraction 7/7、AI replay 8/8（必要事实 24/24、禁用声明命中 0/16、中英双语、八类内容、四个高风险样例）、AI provider replay 5/5、AI long replay 1/1、AI cache replay 1/1、ranking 5/5。
