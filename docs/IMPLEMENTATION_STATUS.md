...
4. 阶段 14 INTEL-001：实现版本化分块、重建和本地/云向量索引端口。
...
- `river_test_harness`：17 组共 110 项检查通过，新增三种降级状态下六项真实 Free 能力的 18 项 Replay；继续覆盖用量、商业权益、云治理、播客转录、云 TTS、云端全文 SSRF、托管 AI、本地排序实验、生产排序、Fixture、Feed、正文提取及 AI Replay。
