...
3. 阶段 7 POD-005：完成迷你播放器、完整播放页以及 Android/iOS/Windows 后台连续播放真机验收。
...
- `river_app`：59 个测试通过，新增收听队列空态、混排、移动、移除、清空及主页入口 Widget 覆盖；继续覆盖播客、本地文件优先播放、同步状态、冲突历史、阅读器、后台媒体、Windows SMTC 与五组跨尺寸 Golden。
