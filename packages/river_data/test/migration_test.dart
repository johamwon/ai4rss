...
void main() {
  test('v1 fixture migrates to v17 without losing article state', () async {
    ...
    expect(await _userVersion(migrated), 17);
    expect(
  ...
  test('interrupted v2 column addition retries idempotently', () async {
    ...
    expect(await _userVersion(recovered), 17);
  });
  ...
  test('v3 fixture creates a searchable index without data loss', () async {
    ...
    expect(await _userVersion(current), 17);
  });
